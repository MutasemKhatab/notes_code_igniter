...
<head>
    ...
    <title><?php echo isset($title) ? htmlspecialchars($title) : 'Sign Up'; ?> - Notes App</title>
...
<body class="min-h-screen bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-700 flex items-center justify-center p-4">
    ...
    <div id="successModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div class="text-center">
                ...
                <p class="text-gray-600 mb-6" id="successMessage">You are now registered and can log in</p>
    ...
    <div id="errorModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div class="text-center">
                ...
                <p class="text-gray-600 mb-6" id="errorMessage">Please check your input and try again</p>
    ...
    <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 overflow-hidden w-full max-w-md">
        ...
        <div class="relative bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-700 text-white p-8 md:p-12 text-center">
            ...
            <div class="relative z-10">
                <h1 class="text-3xl md:text-4xl font-bold mb-4 drop-shadow-lg">Create Account</h1>
                <p class="text-white/90 text-lg">Join us today</p>
            </div>
        </div>
        ...
        <div class="p-8 md:p-12">
            ...
            <form action="<?php echo site_url('users/register'); ?>" method="post" class="space-y-6">
                <div>
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 3.5a.5.5 0 01.5.5v5.793l3.646-3.647a.5.5 0 01.708.708l-4 4a.5.5 0 01-.708 0l-4-4a.5.5 0 11.708-.708L9.5 9.293V4a.5.5 0 01.5-.5zM4.5 12a.5.5 0 01.5-.5h10a.5.5 0 010 1H5a.5.5 0 01-.5-.5z" clip-rule="evenodd"/>
                    </svg>
                    Sign Up
                </button>
            </form>
            ...
            <div class="text-center mt-8">
                <p class="text-gray-600">Already have an account?
                    <a href="<?php echo site_url('users/login'); ?>" class="text-blue-600 hover:text-blue-700 font-semibold transition-colors duration-200">Sign in here</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        <?php if($this->session->flashdata('user_registered')): ?>
            document.getElementById('successMessage').textContent = '<?php echo $this->session->flashdata('user_registered'); ?>';
